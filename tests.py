...
def test_get_books_for_children_add_children_genre_books_get_books(setup):
    setup.add_new_book('Незнайка')
    setup.set_book_genre('Незнайка', 'Мультфильмы')
